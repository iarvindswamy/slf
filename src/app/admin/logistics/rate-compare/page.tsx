...
export default function RateComparePage() {
  ...
  useEffect(() => {
    ...
    // Capture after null check so TypeScript knows it is defined inside load()
  ...
  }, [authLoading, user, selectedFuelId]);
  ...
  return (
    <div className="mx-auto max-w-[1200px]">
      <div className="mb-6">
        ...
        <h2 className="mt-1 text-2xl font-bold text-[#06284c]">Rate Compare</h2>
        <p className="mt-1 text-sm text-slate-500">
          Compare service rates. Fuel surcharge is pulled from the Fuel
          Surcharges master.
        </p>
      </div>
      ...
      <div className="mt-5 rounded-lg bg-slate-50 p-4 text-xs text-slate-600">
        ...
        master. Base rates currently use type-based defaults until a full tariff
        master is added.
      </div>
    </div>
  );
